...
```{r}
gaps <- dbGetQuery(tff.get.conn(), "select * from carga_gaps")
pool::poolClose(tff.get.conn())
```

```{r all-gaps-hist, fig.cap="Histograma del porcentaje de datos faltantes en los datos reportados por todos los dispositivos"}
require(ggplot2)
qplot(gaps$percentageNAs, geom="histogram", main = "Histograma de fallos", 
      xlab = "Porcentaje de fallos", ylab = "Dispositivos", binwidth=1) + 
