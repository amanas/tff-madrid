...
#     list(
#         '2018' = list(
#             '10' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-65-transporte-ptomedida-historico.zip",
#                         device = 'https://datos.madrid.es//egob/catalogo/202468-22-intensidad-trafico.csv'),
#             '9' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-64-transporte-ptomedida-historico.zip",
#                        device = 'https://datos.madrid.es/egob/catalogo/202468-19-intensidad-trafico.zip'),
#             '8' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-63-transporte-ptomedida-historico.zip",
#                        device = 'https://datos.madrid.es/egob/catalogo/202468-18-intensidad-trafico.zip'),
#             '7' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-62-transporte-ptomedida-historico.zip",
#                        device = 'https://datos.madrid.es/egob/catalogo/202468-17-intensidad-trafico.zip'),
#             '6' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-61-transporte-ptomedida-historico.zip",
...
#             '4' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-59-transporte-ptomedida-historico.zip",
#                        device = 'https://datos.madrid.es/egob/catalogo/202468-14-intensidad-trafico.zip'),
#             '3' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-58-transporte-ptomedida-historico.zip",
#                        device = 'https://datos.madrid.es/egob/catalogo/202468-13-intensidad-trafico.zip'),
#             '2' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-57-transporte-ptomedida-historico.zip",
#                        device = 'https://datos.madrid.es/egob/catalogo/202468-12-intensidad-trafico.zip'),
#             '1' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-56-transporte-ptomedida-historico.zip",
#                        device = 'https://datos.madrid.es/egob/catalogo/202468-11-intensidad-trafico.zip')
#         ),
#         '2017' = list(
#             '12' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-55-transporte-ptomedida-historico.zip",
#                         device = 'https://datos.madrid.es/egob/catalogo/202468-10-intensidad-trafico.zip'),
#             '11' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-54-transporte-ptomedida-historico.zip",
#                         device = 'https://datos.madrid.es/egob/catalogo/202468-9-intensidad-trafico.zip'),
#             '10' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-53-transporte-ptomedida-historico.zip",
...
#             '3' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-46-transporte-ptomedida-historico.zip",
#                        metric.sep = ","),
...
#             '3' = list(metric = "https://datos.madrid.es/egob/catalogo/208627-34-transporte-ptomedida-historico.zip",
...
#     s <- rawToChar(base64Encode(bin, "raw"))
#     unlink(tmp)
#     s
# }
#
# decode.obj <- function(s) {
#     tmp <- tempfile()
#     writeBin(base64Decode(s, "raw"), tmp)
#     metric <- readRDS(tmp)
#     unlink(tmp)
#     metric
# }
#
# download.data <- function(y, m, t = c('metric', 'device'), ...) {
#     cat("downloading data ...\n")
#     url <- data.urls()[[as.character(y)]][[as.character(m)]][[t]]
#     sep <- data.urls()[[as.character(y)]][[as.character(m)]][["metric.sep"]]
...
# }
#
# parse.raw.location <- function(df){
#     if("tipo_elem" %in% colnames(df)) {
#         if(is.character(df$tipo_elem)) {
